# this code is based on the Waveshare e-Paper driver code,
# which is (c) 2021 Waveshare under the MIT License
...
class PaperDisplayPortrait(framebuf.FrameBuffer):
    ...
    def ReadBusy(self):
        ...
        while(self.digital_read(self.busy_pin)): # 0 = idle
            self.log(".", False)
            self.delay_ms(20)
        self.log(">")
