...
test = EPD_2in9_Landscape()
test.fill(0x00)
test.fill(0xff)
test.text("Waveshare", 5, 10, 0x00)№
test.text("Pico_ePaper-2.9", 5, 20, 0x00)
test.text("Raspberry Pico", 5, 30, 0x00)
test.display_Base(test.buffer)
test.delay_ms(2000)
test.sleep()